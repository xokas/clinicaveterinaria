...
?>	
<div id="cabecera_pizarra" itemscope itemtype="http://data-vocabulary.org/Organization">
	<div id="cab_ppal">
		...
		<div id="titulo_pizarra" class="postit_pizarra">
			<h1 itemprop="name"><?php echo $cabecera_contenidos->getTitulo()?></h1>
		</div>
		<div id="subtitulo_pizarra" class="postit_pizarra">
			<h2><?php echo $cabecera_contenidos->getSubtitulo()?></h2>
		</div>
	</div>
	<div id="cab_sec">
		<div id="mail_pizarra" class="postit_pizarra">
			<h3 id="correo_contacto"></h3>
		</div>
		<div id="telefonos_pizarra" class="postit_pizarra">
			<h3>
		...
		<div id="direccion_pizarra" class="postit_pizarra">
			<h3>
	...
	<div id="presentacion_pizarra" class="postit_pizarra">
